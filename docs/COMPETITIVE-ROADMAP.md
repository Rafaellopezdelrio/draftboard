...
- [x] Post-game GPI expansion (4: 6→9): `scoreObjectives` uses real objective
  damage share; farming + vision score against rank-bracket baselines
  (`baselineFor`); added a 7th GPI axis **Carril/laning** (CS+gold lead vs your
